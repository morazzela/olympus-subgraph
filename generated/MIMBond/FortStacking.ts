...
export class FortStacking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FortStacking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class FortStacking extends ethereum.SmartContract {
  static bind(address: Address): FortStacking {
    return new FortStacking("FortStacking", address);
  }

  Memories(): Address {
    let result = super.call("Memories", "Memories():(address)", []);

    return result[0].toAddress();
  }

  try_Memories(): ethereum.CallResult<Address> {
    let result = super.tryCall("Memories", "Memories():(address)", []);
    if (result.reverted) {
  ...
  Time(): Address {
    let result = super.call("Time", "Time():(address)", []);

    return result[0].toAddress();
  }

  try_Time(): ethereum.CallResult<Address> {
    let result = super.tryCall("Time", "Time():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  epoch(): FortStacking__epochResult {
    let result = super.call(
      "epoch",
      "epoch():(uint256,uint256,uint32,uint32)",
      []
    );

    return new FortStacking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<FortStacking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint32,uint32)",
      []
  ...
  warmupInfo(param0: Address): FortStacking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new FortStacking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<FortStacking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FortStacking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
