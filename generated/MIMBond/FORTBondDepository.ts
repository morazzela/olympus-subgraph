...
export class FORTBondDepository__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FORTBondDepository__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FORTBondDepository__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FORTBondDepository extends ethereum.SmartContract {
  static bind(address: Address): FORTBondDepository {
    return new FORTBondDepository("FORTBondDepository", address);
  }
  ...
  Fort(): Address {
    let result = super.call("Fort", "Fort():(address)", []);

    return result[0].toAddress();
  }

  try_Fort(): ethereum.CallResult<Address> {
    let result = super.tryCall("Fort", "Fort():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  adjustment(): FORTBondDepository__adjustmentResult {
    let result = super.call(
      "adjustment",
      "adjustment():(bool,uint256,uint256,uint32,uint32)",
      []
    );

    return new FORTBondDepository__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<FORTBondDepository__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new FORTBondDepository__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): FORTBondDepository__bondInfoResult {
    let result = super.call(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint32,uint32)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new FORTBondDepository__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<FORTBondDepository__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint32,uint32)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FORTBondDepository__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  lastDecay(): BigInt {
    let result = super.call("lastDecay", "lastDecay():(uint32)", []);

    return result[0].toBigInt();
  }

  try_lastDecay(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lastDecay", "lastDecay():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  terms(): FORTBondDepository__termsResult {
    let result = super.call(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint32)",
      []
    );

    return new FORTBondDepository__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<FORTBondDepository__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FORTBondDepository__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
