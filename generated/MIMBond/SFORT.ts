...
export class SFORT__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SFORT extends ethereum.SmartContract {
  static bind(address: Address): SFORT {
    return new SFORT("SFORT", address);
  }
  ...
  rebases(param0: BigInt): SFORT__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new SFORT__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<SFORT__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
